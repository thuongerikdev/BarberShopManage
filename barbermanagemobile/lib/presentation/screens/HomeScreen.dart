...
class _HomeScreenState extends State<HomeScreen> {
  final GetSliderImagesUseCase _getSliderImagesUseCase = GetSliderImagesUseCase(
    SliderRepositoryImpl(SliderRemoteDataSource()),
  );
  final GetEmployeesUseCase _getEmployeesUseCase = GetEmployeesUseCase(
    EmployeeRepositoryImpl(EmployeeRemoteDataSource()),
  );
  final GetBookingServicesUseCase _getBookingServicesUseCase = GetBookingServicesUseCase(
    BookingServiceRepositoryImpl(BookingServiceRemoteDataSource()),
  );
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                        ...
                        items: sliderItems.map((item) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(color: shadowColor.withOpacity(0.3), blurRadius: 10, offset: Offset(0, 5)),
                              ],
                            ),
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(15),
              ...
              Container(
                height: 150, // Tăng từ 120 lên 150 để kéo dài phần dịch vụ nổi bật
                ...
                child: Row(
                  ...
                  children: blocks.map((block) {
                    return GestureDetector(
                      onTap: () {
                        _showSnackBar(context, block['title'] as String);
                      },
